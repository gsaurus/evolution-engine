 ...
 * @author  Gil Costa
 */
public class FramePanel extends APanelWithScroll implements MouseMotionListener, MouseListener, ICoordinatesTaker, IFramesTaker{
    /** default serial ID*/
        ...
        if (pickingColor && colorTaker!=null){
                ...
                && tmpY>=0 && tmpY <frame.getImage().getHeight())
            {
                ...
                if (coordinatesTaker != null)
                    coordinatesTaker.takeCoordinates(tmpX,tmpY,0);
            }
		}
		else if (showCM){
