 ...
 *
 */
public class GoodiesCollection extends ACollection<Goodie>{
    
    public ArrayList<String> frames;
    public ArrayList<String> icons;
    
	/** Constructor: an empty FramesCollection */
	public GoodiesCollection(){
        super(GameInvariants.GOODIES_EXTENSION, GameInvariants.GOODIES_VERSION);
    ...
    @Override
    public Goodie readElement(DataInputStream dis) throws IOException {
        return new Goodie(dis, versionID);
    }
